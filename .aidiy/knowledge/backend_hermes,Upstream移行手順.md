# backend_hermes Upstream 移行手順

> 文書: `backend_hermes,Upstream移行手順.md` | 実装: `backend_hermes/` (全ファイル)

## このメモを使う場面

- Nous Research の hermes-agent が新バージョン（v0.13 以降）をリリースした
- `backend_hermes` を upstream の新バージョンへ追従させる必要がある
...
# backend_hermes 全体をバックアップ
$bak = "backend_hermes_bak_$(Get-Date -Format 'yyyyMMdd')"
Copy-Item D:\OneDrive\_sandbox\AiDiy2026\backend_hermes D:\OneDrive\_sandbox\AiDiy2026\$bak
...
# AiDiy 側のファイルリスト
Set-Location D:\OneDrive\_sandbox\AiDiy2026\backend_hermes
Get-ChildItem -Recurse -Filter *.py | ForEach-Object { $_.FullName.Replace("D:\OneDrive\_sandbox\AiDiy2026\backend_hermes\", "") } | Sort-Object > aidiy_files.txt
```
...
$aidiyRoot = "D:\OneDrive\_sandbox\AiDiy2026\backend_hermes"
...
cd D:\OneDrive\_sandbox\AiDiy2026\backend_hermes
...
| ファイル | 更新内容 |
|---------|---------|
| `.aidiy/knowledge/backend_hermes,TUI調整手順.md` | Upstream からの調整点テーブルを v0.13 用に更新 |
| `.aidiy/knowledge/backend_hermes,Upstream移行手順.md` | 本ファイルのファイル分類マップを更新 |
| `backend_hermes/NOTICE.md` | バージョン表記を更新 |
| `backend_hermes/hermes_cli/__init__.py` | `__version__` / `__release_date__` を更新 (該当する場合) |
