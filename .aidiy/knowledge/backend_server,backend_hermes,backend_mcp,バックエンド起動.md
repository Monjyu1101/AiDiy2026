...
> 文書: `backend_server,backend_hermes,backend_mcp,バックエンド起動.md` | 実装: `_start.py`, `backend_server/temp/reboot_core.txt`
...
- `backend_mcp/temp/reboot_mcp.txt` — mcp 再起動トリガー
...
New-Item -ItemType File -Force backend_mcp/temp/reboot_mcp.txt
```
