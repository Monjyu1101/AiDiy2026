# backend_mcp HTTP API の save_path 挙動

> 文書: `backend_mcp,HTTP_API_save_path挙動.md` | 実装: `backend_mcp/mcp_main.py`
...
- `../temp/output/` は `backend_mcp/mcp_main.py` からの相対パス（= プロジェクトルートの `temp/output/`）
