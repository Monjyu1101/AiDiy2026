...
> 文書: `backend_hermes,TUI調整手順.md` | 実装: `backend_hermes/cli_main.py`, `backend_hermes/hermes_cli/commands.py`
...
- `backend_hermes_old/cli_main.py` — 旧 AiDiy Hermes 実装の参照元
...
この `backend_hermes` は [Nous Research の hermes-agent](https://github.com/nousresearch/hermes-agent) v0.12.0 (MIT License) をフォークし、AiDiy 用に以下の調整を加えています。
