...
> 文書: `backend_server,backend_hermes,frontend_avatar,CodeCLI表示ANSI制御コード対処.md` | 実装: `backend_server/core_router/AIコア/AIコード_cli.py`, `frontend_avatar/src/components/AIコード.vue`
