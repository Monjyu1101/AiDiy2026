...
> 文書: `command_hermes,backend_server,運用手順.md` | 実装: `command_hermes/cli_main.py`, `backend_server/core_router/AIコア/AIコード_hermes.py`
...
- `command_hermes/core/run_agent.py`
