...
> 文書: `frontend_avatar,frontend_web,アバター表示とVRMA.md` | 実装: `frontend_avatar/src/components/AIコア.vue`, `frontend_avatar/src/components/Avatar.vue`
...
- VRMA 追加時は `.aidiy/knowledge/frontend_avatar,VRM_VRMA追加手順.md` も確認する。
