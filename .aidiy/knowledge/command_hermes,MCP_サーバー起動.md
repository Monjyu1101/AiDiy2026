# command_hermes MCP サーバー起動

> 文書: `command_hermes,MCP_サーバー起動.md` | 実装: `command_hermes/base/mcp_serve.py`, `command_hermes/hermes_cli/mcp_config.py`
...
`hermes mcp serve` を実行すると command_hermes が **stdio MCP サーバー** として起動し、
