...
> 文書: `backend_server,backend_mcp,MCP活用手順.md` | 実装: `backend_server/_config/AiDiy_mcp.json`, `backend_server/core_router/AIコア/AIコード_claude.py`
...
- `backend_mcp/mcp_main.py` — 14個の SSE MCP サーバー入口
