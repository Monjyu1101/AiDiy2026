      ...
      "dialogue": [
        {
          ...
          "naration_text": "こんにちは！本日は2026年前半、1月から6月にかけてAnthropicが世界に打ち出した主要ニュースを一気に振り返ります！毎月重要な発表が続いた怒涛の半年でしたよ。Claude 4シリーズの登場から始まって、業界の常識を変えるような発表が相次ぎました。このニュース解説はAiDiyのビデオ生成機能で作られています！",
    ...
    },
    {
      ...
      "dialogue": [
        ...
        },
        {
          ...
          "naration_text": "2026年後半に向けては、マルチモーダル能力のさらなる向上・エージェント型AIの自律性向上・新興市場への展開加速・新業界への特化ソリューション発表などが期待されています。前半以上に動きが大きい可能性もあって、目が離せないですよ！引き続き一緒に注目していきましょう！",
        ...
        },
        {
          "speaker": "male",
          "expression": "neutral",
          "telop_text": "本日もご視聴いただきありがとうございました！また次回の動画でお会いしましょう！",
          "naration_text": "本日は2026年前半のAnthropicニュースを総まとめでお届けしました。次回は後半のニュースをお届け予定ですので、ぜひチャンネル登録してお待ちください！本日もご視聴いただきありがとうございました！また次回の動画でお会いしましょう！",
