window.SCENARIO = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "short_start_sec": 9.624,
      "short_duration_sec": 7.128,
      "long_start_sec": 47.496,
    ...
    },
    {
      ...
      "short_start_sec": 16.752,
      "short_duration_sec": 7.92,
      "long_start_sec": 101.064,
    ...
    },
    {
      ...
      "short_start_sec": 24.672,
      "short_duration_sec": 8.616,
      "long_start_sec": 154.824,
    ...
    },
    {
      ...
      "short_start_sec": 33.288,
      "short_duration_sec": 8.136,
      "long_start_sec": 206.904,
    ...
    },
    {
      ...
      "long_narration": "V商品推移表から各伝票画面への移動は、実装上かなり便利に作られています。入庫のセルをダブルクリックするとT商品入庫一覧へ、出庫のセルならT商品出庫一覧へ、在庫行ならT商品棚卸一覧へ移動します。生産受入のセルはT生産一覧へ、生産払出のセルはT生産払出一覧へ移動します。そのとき、日付、商品ID、戻URLを持って移動するので、対象データを絞り込んだ状態で開けます。戻URLがあるため、確認後に推移表へ戻る流れも自然です。さらに推移表は30秒ごとに最終更新日時を確認し、更新があれば再読み込みします。最近更新されたセルは点滅表示されるので、どこが変わったかにも気づきやすくなっています。",
      "short_audio": "audio/short_scene_005.mp3",
      "long_audio": "audio/long_scene_005.mp3",
      "short_start_sec": 41.424,
      "short_duration_sec": 8.4,
      "long_start_sec": 260.208,
    ...
    },
    {
      ...
      "short_start_sec": 49.824,
      "short_duration_sec": 9.792,
      "long_start_sec": 310.56,
