window.SCENARIO = {
  ...
  "scenes": [
      ...
      "dialogue": [
        {
          "speaker": "female",
          "expression": "neutral",
          "telop_text": "皆さん、こんにちは！今日は2026年前半のGoogleの主要ニュースを振り返ります。Google I/O 2026の発表も盛り込んでお届けします。",
          "naration_text": "皆さん、こんにちは！本日は2026年1月から5月にかけて発表された、Googleの主要ニュースを時系列で詳しく振り返っていきます。なお、このニュース解説動画は、AiDiyのニュース版ビデオ生成機能で作られています。AIの世界はこの半年間で大きく動きましたので、一緒に確認していきましょう。今回は7つのテーマに分けてお届けしますので、最後までぜひお付き合いください。",
    ...
    },
    {
      ...
      "metrics": [
        { "label": "新モデル数", "value": "4+" },
        { "label": "Veo 3.1", "value": "動画生成" },
        { "label": "Deep Think", "value": "科学・研究" }
      ],
      "cards": [
        {
    ...
    },
    {
      ...
      "metrics": [
        { "label": "Lyria 3", "value": "音楽生成" },
        { "label": "Flash-Lite", "value": "大量処理" },
        { "label": "AlphaGo", "value": "10周年" }
      ],
      "cards": [
        {
    ...
    },
    {
      ...
      "metrics": [
        { "label": "Gemma 4", "value": "最高OSSモデル" },
        { "label": "Robotics", "value": "ER 1.6" },
        { "label": "医療AI", "value": "Co-Clinician" }
      ],
      "cards": [
        {
          "title": "Gemma 4",
    ...
    },
    {
      ...
      "metrics": [
        { "label": "物流効率", "value": "+10.4%" },
        { "label": "量子回路", "value": "誤り10分の1" },
        { "label": "AI Pointer", "value": "Chrome対応" }
      ],
      "cards": [
        {
    ...
    },
    {
      ...
      "metrics": [
        { "label": "SWE-Bench Pro", "value": "55.1%" },
        { "label": "ARC-AGI-2", "value": "72.1%" },
        { "label": "Terminal-bench", "value": "76.2%" }
      ],
      "cards": [
        {
    ...
    },
    {
      ...
      "metrics": [
        { "label": "Antigravity", "value": "Vibe Coding" },
        { "label": "量子+AI", "value": "次世代基盤" },
        { "label": "Android XR", "value": "新体験" }
      ],
      "cards": [
        {
    ...
    },
    {
      ...
      "dialogue": [
        ...
        },
        {
          "speaker": "female",
          "expression": "neutral",
          "telop_text": "GoogleのAI戦略の核心は、世界の情報を整理しあらゆる人に届けるという創業以来のミッションを、AIで加速することです。今後の展開も目が離せません！",
          "naration_text": "GoogleのAI戦略の核心にあるのは、「世界の情報を整理し、あらゆる人にとってアクセス可能で有益なものにする」という創業以来のミッションをAIで加速させることです。モデルの進化・生成AI・エージェント・科学応用・量子という複数の戦略軸が相互に強化し合い、Google全体のAI力が高まっています。2026年下半期もGemini 3.5 Pro、Android XR、そして量子AIの進展など、見逃せない発表が続くことでしょう。ぜひこれからも注目してみてください！",
