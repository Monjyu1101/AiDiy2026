...
def build_prompt(scene):
    ...
    lines = [
        "Create a clean, modern widescreen illustration for a Japanese technology use-case presentation.",
    ]
    if kicker:
    ...
    lines.append("Style: polished product use-case visual, cinematic lighting, readable composition, no text overlay baked into the image.")
    if forbidden:
