  ...
  "scenes": [
    {
      ...
      "kicker": "AIDIY HERMES",
      "headline": "AiDiy 専用に組み込まれた\non-demand コードエージェント CLI",
      "lead": "Nous Research hermes-agent をベースに、AiDiy の provider 体系・TUI・AiDiy 連携を独自実装したコード支援 CLI。",
      "subtitle": "AiDiy Hermes — 位置づけ・Provider・Slash Command・連携を紹介します。",
      "narration": "この紹介では、AiDiy 専用のコードエージェント CLI、aidiy_hermes の実態を説明します。位置づけ、技術スタック、Provider、Slash Command、そして AiDiy との連携まで順に見ていきます。",
