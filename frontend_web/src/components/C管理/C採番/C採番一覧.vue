...
import SerialListTable from './components/C採番一覧テーブル.vue';
...
const handleReload = () => {
  serialListTableRef.value?.loadData();
};

const openCreate = () => {
  router.push({ path: '/C管理/C採番/編集', query: { モード: '新規' } });
};
  ...
  <div class="page-container">
    ...
    <div class="content">
      <div class="section">
        ...
        <SerialListTable ref="serialListTableRef" />
      </div>
    </div>
  </div>
</template>
