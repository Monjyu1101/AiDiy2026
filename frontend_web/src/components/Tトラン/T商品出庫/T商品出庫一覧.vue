...
import 商品出庫一覧テーブル from './components/T商品出庫一覧テーブル.vue';
...
<template>
  <div class="page-container">
    <h2 class="page-title">
      <span class="title-text">【 T商品出庫 】</span>
