  ...
  <div class="page-container">
    ...
    <div class="content">
      <div class="section">
        ...
        <component :is="配車区分一覧テーブル" ref="配車区分一覧テーブルRef" :件数制限="件数制限" :無効も表示="無効も表示" :有効列表示="有効列表示" :URLメニュー="URLメニュー" :URL戻り先="現在URL戻り先" />
      </div>
    </div>
  </div>
</template>
