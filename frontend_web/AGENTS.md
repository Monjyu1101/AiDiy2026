...
| 目的 | 参照先 |
|------|--------|
| frontend_web の実装パターン、UI ルール、qTubler、明細型編集 | [`../.aidiy/knowledge/frontendWeb実装パターン.md`](../.aidiy/knowledge/frontendWeb実装パターン.md) |
| 業務画面追加 | [`../.aidiy/knowledge/frontendWeb画面追加手順.md`](../.aidiy/knowledge/frontendWeb画面追加手順.md) |
| X系静的画面 / ゲーム / デモ追加 | [`../.aidiy/knowledge/X系静的画面追加.md`](../.aidiy/knowledge/X系静的画面追加.md) |
| Vite proxy / CORS / ポート | [`../.aidiy/knowledge/Viteプロキシ設定.md`](../.aidiy/knowledge/Viteプロキシ設定.md) |
| JWT 認証 | [`../.aidiy/knowledge/JWT認証フロー.md`](../.aidiy/knowledge/JWT認証フロー.md) |
| 認証延長 | [`../.aidiy/knowledge/認証延長ルール.md`](../.aidiy/knowledge/認証延長ルール.md) |
| AI コア WebSocket | [`../.aidiy/knowledge/AIコアWebSocket仕様.md`](../.aidiy/knowledge/AIコアWebSocket仕様.md) |
| AI モデル設定 | [`../.aidiy/knowledge/AIモデル設定変更手順.md`](../.aidiy/knowledge/AIモデル設定変更手順.md) |
| 開発環境起動、type-check、よくある問題 | [`../.aidiy/knowledge/開発環境運用手順.md`](../.aidiy/knowledge/開発環境運用手順.md) |

## 概要

`frontend_web` は AiDiy の通常 Web UI です。
管理画面、マスタ、トランザクション、ビュー、スケジューラ、AIコア、X系デモを提供します。
...
- API は `/core/*` と `/apps/*` を Vite proxy 経由で呼ぶ。
...
| `index.ts` | base route、カテゴリ route、ログインなど |
