...
def build_top_level_parser():
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=False,
        help="Accepted for compatibility; the AiDiy build always uses the Python prompt_toolkit TUI",
    )
    _inherited_flag(
        parser,
        "--cli",
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=False,
        help="Accepted for compatibility; no effect in the AiDiy Python TUI build",
    )
