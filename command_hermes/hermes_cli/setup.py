...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "ai-gateway": ["anthropic/claude-opus-5.5", "anthropic/claude-sonnet-5", "openai/gpt-6-sol", "google/gemini-3-flash"],
    "kilocode": ["anthropic/claude-sonnet-5", "anthropic/claude-opus-5.5", "openai/gpt-6-sol", "google/gemini-3-pro-preview", "google/gemini-3-flash-preview"],
    "opencode-zen": ["x-preview-f-free", "gpt-6-sol", "claude-opus-5.5", "claude-sonnet-5", "gemini-3.7-flash", "glm-5.2", "kimi-k3", "minimax-m3"],
    ...
    "opencode-go": ["kimi-k3", "kimi-k2.7-code", "kimi-k2.6", "gpt-6-luna", "grok-4.5", "glm-5.3", "glm-5.3-flash", "glm-5.2", "mimo-v2.5-pro", "mimo-v2.5", "minimax-m3", "minimax-m2.7", "qwen3.8-max", "qwen3.7-max", "deepseek-v4-pro", "hy3"],
    "huggingface": [
