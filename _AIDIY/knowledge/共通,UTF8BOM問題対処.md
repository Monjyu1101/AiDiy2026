...
> 文書: `共通,UTF8BOM問題対処.md` | 実装: `scripts/bom_anomaly_list.py`, `scripts/remove_bom.py`
...
```powershell
$files = @(
  "_AIDIY/knowledge/backend_server,frontend_web,frontend_avatar,JWT認証フロー.md",
  "_AIDIY/knowledge/共通,Markdown現状追従チェック.md"
)
