...
| `coreRouter.ts` | Core 系 | C管理（権限/利用者/採番）、AiDiy、AIタスク、AIチーム |
...
| `/AIタスク` | AIタスク（backend_taskteam の `/task/*`） |
| `/AIチーム` | AIチーム（backend_taskteam の `/team/*`） |
