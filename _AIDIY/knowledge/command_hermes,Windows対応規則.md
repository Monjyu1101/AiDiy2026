...
> 文書: `command_hermes,Windows対応規則.md` | 実装: `command_hermes/base/hermes_constants.py`, `command_hermes/tools/environments/local.py`, `command_hermes/tools/environments/base.py`, `command_hermes/tools/file_operations.py`, `command_hermes/tools/file_operations_linux.py`, `command_hermes/tools/file_operations_win.py`, `command_hermes/tools/file_tools.py`, `command_hermes/tools/file_tools_linux.py`, `command_hermes/tools/file_tools_win.py`, `command_hermes/tools/terminal_tool.py`, `command_hermes/tools/terminal_tool_linux.py`, `command_hermes/tools/terminal_tool_win.py`, `command_hermes/tools/process_registry.py`, `command_hermes/tools/process_registry_linux.py`, `command_hermes/tools/process_registry_win.py`
...
6. **判定ヘルパーは `command_hermes/base/hermes_constants.py` の `is_windows_native()`** を使う。
...
cat _AIDIY/knowledge/_index.md
```

ツール経由:

- `read_file('_AIDIY/knowledge/_index.md')` で読める
- `search_files(target='files', pattern='*.md', path='command_hermes')` で結果が返る
- `search_files(target='content', pattern='def is_wsl', path='command_hermes')` で結果が返る
...
- 「`_AIDIY/knowledge/_index.md` を読んで要約して」が 30 秒以内に応答する
