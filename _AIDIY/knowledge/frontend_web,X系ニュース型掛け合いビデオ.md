...
> 文書: `frontend_web,X系ニュース型掛け合いビデオ.md` | 実装: `frontend_web/public/Xビデオ/ニュース_20260521_anthropic2026前半_ja/index.html`, `frontend_web/public/Xビデオ/ニュース_20260521_anthropic2026前半_ja/scenario.js`, `frontend_web/public/Xビデオ/ニュース_20260521_anthropic2026前半_ja/_gen_dialogue_audio.py`
...
2. 既存の `ニュース_20260521_anthropic2026前半_ja/` を手本として以下をコピー・修正:
