...
| 目的 | 参照先 |
|------|--------|
| Electron / Web 両対応の変更チェック | [`../.aidiy/knowledge/frontendAvatar変更チェック.md`](../.aidiy/knowledge/frontendAvatar変更チェック.md) |
| Electron IPC 追加 | [`../.aidiy/knowledge/ElectronIPC追加手順.md`](../.aidiy/knowledge/ElectronIPC追加手順.md) |
| VRM / VRMA 追加 | [`../.aidiy/knowledge/VRM_VRMA追加手順.md`](../.aidiy/knowledge/VRM_VRMA追加手順.md) |
| アバター表示、VRMA 再生、表示選択 UI | [`../.aidiy/knowledge/アバター表示とVRMA.md`](../.aidiy/knowledge/アバター表示とVRMA.md) |
| xneko / xeyes ウィジェット | [`../.aidiy/knowledge/xneko_xeyesウィジェット追加手順.md`](../.aidiy/knowledge/xneko_xeyesウィジェット追加手順.md) |
| 音声入力・音声再生 | [`../.aidiy/knowledge/AI音声処理.md`](../.aidiy/knowledge/AI音声処理.md) |
| AI WebSocket packet | [`../.aidiy/knowledge/AIコアWebSocket仕様.md`](../.aidiy/knowledge/AIコアWebSocket仕様.md) |
...
| API | `/core` proxy / config | `/core` proxy / 動的 URL |
...
| `src/api/config.ts` | API URL、モデル設定、VRM / VRMA 定数 |
| `src/components/AiDiy/` | AIコア、Avatar、音声、各パネル |
