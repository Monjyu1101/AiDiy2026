...
async function loadConfig() {
  ...
  try {
    ...
    const taskModelKeys = Object.keys(availableModels.value?.code_models?.[selections.taskAi] || {})
    ...
    const teamModelKeys = Object.keys(availableModels.value?.code_models?.[selections.teamAi] || {})
