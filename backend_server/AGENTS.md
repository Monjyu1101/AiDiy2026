...
| 目的 | 参照先 |
|------|--------|
| backend の層構造、Model / Schema / CRUD / Router パターン | [`../.aidiy/knowledge/backend実装パターン.md`](../.aidiy/knowledge/backend実装パターン.md) |
| 開発環境起動、依存関係、DB、Swagger、よくある問題 | [`../.aidiy/knowledge/開発環境運用手順.md`](../.aidiy/knowledge/開発環境運用手順.md) |
| 既存 DB へのスキーマ差分反映 | [`../.aidiy/knowledge/スキーマ変更手順.md`](../.aidiy/knowledge/スキーマ変更手順.md) |
| C採番と監査フィールド | [`../.aidiy/knowledge/C採番と監査フィールド.md`](../.aidiy/knowledge/C採番と監査フィールド.md) |
| C利用者パスワード運用 | [`../.aidiy/knowledge/C利用者パスワード運用.md`](../.aidiy/knowledge/C利用者パスワード運用.md) |
| JWT 認証 | [`../.aidiy/knowledge/JWT認証フロー.md`](../.aidiy/knowledge/JWT認証フロー.md) |
| M系マスタ追加 | [`../.aidiy/knowledge/M系マスタ追加手順.md`](../.aidiy/knowledge/M系マスタ追加手順.md) |
| T系トランザクション追加 | [`../.aidiy/knowledge/T系トランザクション追加手順.md`](../.aidiy/knowledge/T系トランザクション追加手順.md) |
| V系エンドポイント追加 | [`../.aidiy/knowledge/V系エンドポイント追加手順.md`](../.aidiy/knowledge/V系エンドポイント追加手順.md) |
| S系スケジューラ追加 | [`../.aidiy/knowledge/S系スケジューラ追加手順.md`](../.aidiy/knowledge/S系スケジューラ追加手順.md) |
| AIコア WebSocket | [`../.aidiy/knowledge/AIコアWebSocket仕様.md`](../.aidiy/knowledge/AIコアWebSocket仕様.md) |
| AIモデル設定 | [`../.aidiy/knowledge/AIモデル設定変更手順.md`](../.aidiy/knowledge/AIモデル設定変更手順.md) |
| Code CLI 追加 | [`../.aidiy/knowledge/CodeCLI追加手順.md`](../.aidiy/knowledge/CodeCLI追加手順.md) |
| MCP 構成・活用 | [`../.aidiy/knowledge/backendMCP構成.md`](../.aidiy/knowledge/backendMCP構成.md)、[`../.aidiy/knowledge/MCP活用手順.md`](../.aidiy/knowledge/MCP活用手順.md) |
...
`backend_server/conf/` が設定管理の中心です。

| ファイル | 役割 |
|----------|------|
| `conf_json.py` | `AiDiy_key.json` の読み書き、不足キーの補完 |
| `conf_model.py` | AI モデル一覧、`AiDiy_live_*.json`、`AiDiy_code_*.json`、`AiDiy_mcp.json` |
| `conf_path.py` | 実行パス、外部プロジェクト検出 |

主な設定ファイル:

- `_config/AiDiy_key.json`
- `_config/AiDiy_chat__context.json`
- `_config/AiDiy_live__context.json`
- `_config/AiDiy_code__context.json`
- `_config/AiDiy_mcp.json`
- `_config/AiDiy_live_*.json`
- `_config/AiDiy_code_*.json`
