...
class DailyDateFileHandler(logging.FileHandler):
    ...
    例: temp/logs/yyyymmdd.hh0000.taskteam_main.log
    """

    def __init__(self, log_dir: str, prefix: str = "taskteam_main", encoding: str = "utf-8"):
...
def setup_logging(instance_name: str = "taskteam_main"):
    """
    アプリケーション全体のログ設定を初期化
    最初に1回だけ呼ばれる
    """
    ...
    instance = (instance_name or "taskteam_main").strip() or "taskteam_main"
