...
async def get_status():
    ...
    try:
#         from gateway.config import load_gateway_config  # removed: not in aidiy
...
def get_model_info():
    ...
    try:
        ...
        try:
            from core.model_metadata import get_model_context_length
...
async def disconnect_oauth_provider(provider_id: str, request: Request):
    ...
    if provider_id in ("anthropic", "claude-code"):
        try:
            from core.anthropic_adapter import _HERMES_OAUTH_FILE
...
async def get_logs(
    ...
    try:
        from base.hermes_logging import COMPONENT_PREFIXES
    except ImportError:
        COMPONENT_PREFIXES = {}
...
#     from tui_gateway.ws import handle_ws  # removed: not in aidiy
