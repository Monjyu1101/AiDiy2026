...
from core.credential_pool import CredentialPool, PooledCredential, get_custom_provider_pool_key, load_pool
...
from base.utils import base_url_host_matches, base_url_hostname
...
def _resolve_explicit_runtime(
    *,
    ...
    if provider == "anthropic":
        ...
        api_key = explicit_api_key
        if not api_key:
            from core.anthropic_adapter import resolve_anthropic_token
