...
from base.hermes_constants import OPENROUTER_MODELS_URL
from base.utils import base_url_host_matches
...
from base.hermes_constants import is_termux as _is_termux
...
def run_doctor(args):
                ...
                if should_fix:
                    ...
                    for k in stale_root_keys:
                        if not model_section.get(k):
                            ...
                            raw_config.pop(k)
                    from base.utils import atomic_yaml_write
    ...
    if anthropic_key:
        ...
        try:
            import httpx
            from core.anthropic_adapter import _is_oauth_token, _COMMON_BETAS, _OAUTH_ONLY_BETAS
        ...
        if _key:
            ...
            try:
                ...
                if _base and _base.rstrip("/").endswith("/anthropic"):
                    from core.auxiliary_client import _to_openai_base_url
    ...
    try:
        ...
        from base.model_tools import check_tool_availability, TOOLSET_REQUIREMENTS
