...
def get_container_exec_info() -> Optional[dict]:
    ...
    from base.hermes_constants import is_container
    if is_container():
        return None
...
from base.hermes_constants import get_hermes_home  # noqa: F811,E402
...
def get_missing_skill_config_vars() -> List[Dict[str, Any]]:
    ...
    """
    try:
        from core.skill_utils import discover_all_skill_config_vars, SKILL_CONFIG_PREFIX
    except Exception:
        return []
...
def migrate_config(interactive: bool = True, quiet: bool = False) -> Dict[str, Any]:
    ...
    if missing_skill_config and interactive and not quiet:
        ...
        if answer in ("y", "yes"):
            ...
            config = load_config()
            try:
                from core.skill_utils import SKILL_CONFIG_PREFIX
            except Exception:
...
def show_config():
    ...
    # Skill config
    try:
        from core.skill_utils import discover_all_skill_config_vars, resolve_skill_config_values
