...
from base.utils import base_url_hostname
...
def _print_setup_summary(config: dict, hermes_home):
    ...
    try:
        from core.auxiliary_client import get_available_vision_backends
    ...
    if disabled_tools:
        ...
        from base.hermes_constants import display_hermes_home as _dhh
