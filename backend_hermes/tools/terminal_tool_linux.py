...
# Covers alphanumeric, POSIX path separators, tilde, dot, hyphen, underscore,
# space, plus, at, equals, and comma.  Everything else is rejected.
...
TERMINAL_TOOL_DESCRIPTION = """Execute shell commands in the configured local shell. Filesystem usually persists between calls.
