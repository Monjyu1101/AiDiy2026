...
| 起動、依存関係、DB、API確認、よくある問題 | [`.aidiy/knowledge/開発環境運用手順.md`](./.aidiy/knowledge/開発環境運用手順.md) |
| Backend API / DB 追加 | [`.aidiy/knowledge/M系マスタ追加手順.md`](./.aidiy/knowledge/M系マスタ追加手順.md)、[`.aidiy/knowledge/T系トランザクション追加手順.md`](./.aidiy/knowledge/T系トランザクション追加手順.md)、[`.aidiy/knowledge/V系エンドポイント追加手順.md`](./.aidiy/knowledge/V系エンドポイント追加手順.md)、[`.aidiy/knowledge/S系スケジューラ追加手順.md`](./.aidiy/knowledge/S系スケジューラ追加手順.md) |
| スキーマ変更 | [`.aidiy/knowledge/スキーマ変更手順.md`](./.aidiy/knowledge/スキーマ変更手順.md) |
| frontend_web 画面追加 | [`.aidiy/knowledge/frontendWeb画面追加手順.md`](./.aidiy/knowledge/frontendWeb画面追加手順.md) |
| frontend_avatar / Electron / VRM / 音声 | [`.aidiy/knowledge/ElectronIPC追加手順.md`](./.aidiy/knowledge/ElectronIPC追加手順.md)、[`.aidiy/knowledge/VRM_VRMA追加手順.md`](./.aidiy/knowledge/VRM_VRMA追加手順.md)、[`.aidiy/knowledge/AI音声処理.md`](./.aidiy/knowledge/AI音声処理.md) |
| AI コア / Code CLI / MCP | [`.aidiy/knowledge/AIコアWebSocket仕様.md`](./.aidiy/knowledge/AIコアWebSocket仕様.md)、[`.aidiy/knowledge/CodeCLI追加手順.md`](./.aidiy/knowledge/CodeCLI追加手順.md)、[`.aidiy/knowledge/MCP活用手順.md`](./.aidiy/knowledge/MCP活用手順.md) |
| GitHub issue 運用 | [`.aidiy/knowledge/GitHubIssue運用手順.md`](./.aidiy/knowledge/GitHubIssue運用手順.md) |
...
| [backend_mcp/AGENTS.md](./backend_mcp/AGENTS.md) | MCP サーバー群の実装詳細 |
...
| `backend_mcp/mcp_main.py` | MCP サーバー群 | 8095 |
...
| `backend_mcp/` | Chrome DevTools、Desktop Capture、SQLite、PostgreSQL、Logs、Code Check、Backup Check、Backup Save の MCP |
...
スキーマ変更の具体手順は `.aidiy/knowledge/スキーマ変更手順.md` を参照してください。
...
`backend_mcp` は 8 つの MCP サーバーを同居させます。
...
| `aidiy_logs` | backend_server / backend_mcp ログ確認 |
| `aidiy_code_check` | Python 構文 / ruff / TypeScript 型チェック |
| `aidiy_backup_check` | 差分バックアップ確認 |
| `aidiy_backup_save` | 差分バックアップ保存 |

MCP の使い分けと設定は `.aidiy/knowledge/MCP活用手順.md` を参照してください。
