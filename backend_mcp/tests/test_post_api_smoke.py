...
"""
backend_mcp HTTP POST API スモークテスト
...
def main() -> None:
    print("=== backend_mcp HTTP POST API スモークテスト ===")
    ...
    syntax = post(
        ...
        {"file_path": "backend_mcp/mcp_main.py", "venv_project": "backend_mcp"},
    )
    ...
    versions = post("/aidiy_backup/check/versions", {"path": "backend_mcp/mcp_main.py"})
