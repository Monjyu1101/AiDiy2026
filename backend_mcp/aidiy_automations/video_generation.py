...
# コピー元テンプレート。ニュース型の index.html / scenario.js / 生成補助スクリプトを流用する。
DEFAULT_TEMPLATE_DIR = r"D:\OneDrive\_sandbox\AiDiy2026\frontend_web\public\Xビデオ\ニュース_20260521_google2026前半"
...
DEFAULT_FOLDER_NAME = "ニュース_自動生成"
DEFAULT_TOPIC = "AiDiy 自動化ソリューションの紹介ビデオ"
...
def count_scenario_dialogues(scenario_path: str) -> int:
    """scenario.js に含まれる dialogue 件数を返す。"""
    data = load_scenario_object(scenario_path)
    count = 0
    for scene in data.get("scenes", []):
        dialogues = scene.get("dialogue", [])
